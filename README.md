...
## Sample Generated Comic Panels

The following panels were generated by the comic generator using SDXL-Turbo during a real autonomous game run. Each image was produced from a narrative moment extracted from the agent chat.

**Scene 0 — The Village of Millhaven**

![Villagers gathered around the stone well at sunset](docs/comic-panel-village-gathering.png)
*Villagers gathered around the stone well in Millhaven*

![The village square as the party prepares to depart](docs/comic-panel-village-square.png)
*The village square as the party prepares to depart*

![Thorin in the village](docs/comic-panel-thorin-village.png)
*Thorin the dwarven fighter, ready for the mission*

**Scene 1 — Crypt Entrance**

![The mossy stone stairway descending into the crypt](docs/comic-panel-crypt-stairs.png)
*The mossy stairway descending into the crypt*

![Green-lit corridors of the crypt interior](docs/comic-panel-crypt-descent.png)
*Green-lit corridors of the crypt interior*

![The party arrives at the crypt entrance](docs/comic-panel-crypt-entrance.png)
*The party arrives at the crypt entrance*

![Two skeleton guards blocking the corridor](docs/comic-panel-skeleton-guards.png)
*Two skeleton guards blocking the corridor — Scene 1 combat*

**Characters in Combat**

![Thorin the dwarven fighter charging into battle](docs/comic-panel-thorin-battle.png)
*Thorin charging into melee*

![Elara the elven wizard unleashing fire magic](docs/comic-panel-elara-magic.png)
*Elara unleashing fire magic*

**Scene 2 — The Shadow Lord's Chamber**

![The Shadow Lord's underground crystal chamber](docs/comic-panel-shadow-chamber.png)
*The Shadow Lord's underground chamber, filled with purple crystals*

![The Shadow Lord on his dark throne](docs/comic-panel-shadow-lord.png)
*The Shadow Lord commands from his throne*

![The party's climactic battle against the Shadow Lord](docs/comic-panel-boss-battle.png)
*The climactic boss battle — lightning and magic clash in the final chamber*
